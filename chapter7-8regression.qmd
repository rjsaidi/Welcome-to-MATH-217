...
![https://www.istockphoto.com/photos/cute-possum](Fall%202023/cute%20possum.png){width="370"}
...
**_____% of the variation in the observations may be explained by this model.**
...
```{r}
ggplot(possum, aes(x=head_l, y=total_l))+
  geom_point(aes(color = age)) + # gradient can only be used to color numerical variable
